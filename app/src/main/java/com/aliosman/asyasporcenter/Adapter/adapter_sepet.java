...
public class adapter_sepet extends RecyclerView.Adapter<adapter_sepet.ViewHolder> implements Serializable {
    List<Urun> uruns;
    IRecylerItemClick click;
    String TAG = getClass().getName();
    public adapter_sepet(List<Urun> uruns){
        this.uruns=uruns;
    }
    public adapter_sepet(List<Urun> uruns, IRecylerItemClick click){
        this.uruns=uruns;
        this.click=click;
    }
    @Override
